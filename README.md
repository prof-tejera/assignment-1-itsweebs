...
5. Deploy your application using any method you like (we will provide instructions for GH actions): https://prof-tejera.github.io/assignment-1-itsweebs

Note: Styling inspired by Apple & VS Code dark theme -- dark background with neon colors but all styling is my own. 
